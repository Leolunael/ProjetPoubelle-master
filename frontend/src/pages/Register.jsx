export default function Register() {
  return (
    <div className="flex min-h-screen justify-center bg-gray-200 pt-32">
      <div className="flex w-md flex-col gap-6 p-6">
        ...
        <div className="flex w-full flex-row items-center gap-2.5">
          ...
          <p className="text-sm">Recevez les mises à jour et les actualités.</p>
        </div>
        ...
        <p className="w-full text-center text-sm font-medium sm:text-base">
          ...
          <span className="cursor-pointer text-green-700">Connexion</span>
        </p>
      </div>
    </div>
  );
