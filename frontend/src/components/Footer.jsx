  ...
  social: [
    ...
    },
    {
      ...
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            d="M13.6823 10.6218L20.2391
          3H18.6854L12.9921 9.61788L8.44486
          3H3.2002L10.0765 13.0074L3.2002
          21H4.75404L10.7663 14.0113L15.5685
          21H20.8131L13.6819 10.6218H13.6823ZM11.5541
          13.0956L10.8574 12.0991L5.31391
          4.16971H7.70053L12.1742 10.5689L12.8709
          11.5655L18.6861 19.8835H16.2995L11.5541
          13.096V13.0956Z"
          />
        </svg>
      ),
      ...
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            ...
            0 0 .84-.27 2.75
            1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115
      ...
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            ...
            1-1.768-1.768C2 15.255 2 12 2
            12s0-3.255.417-4.814a2.507
            2.507 0 0 1 1.768-1.768C5.744
            5 11.998 5 11.998 5s6.255 0
            7.814.418ZM15.194 12 10 15V9l5.194
            3Z"
            clipRule="evenodd"
          />
        </svg>
    ...
    <footer className="bg-green-950">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-400">
          &copy; 2024 Your Company, Inc. Tous droits réservés.
        </p>
      </div>
    </footer>
  );
